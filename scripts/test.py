...
x_23 = 0.02  # Between Bus 2 and Bus 3
x_13 = 0.01  # Between Bus 1 and Bus 3 (direct line)
demand_value = 98.4  # Full demand at Bus 3

# Power balance equations with θ2 and θ3, and direct line from Bus 1 to Bus 3
# Corrected coefficients
A_eq = [
    [1, 0, (1 / x_12), (1 / x_13)], # Bus 1
    [0, 1, - (1 / x_12 + 1 / x_23), (1 / x_23)],  # Bus 2
    [0, 0, (1 / x_23), - (1 / x_13 + 1 / x_23)]  # Bus 3
]
