...
# Extract data
total_demand = data["total_demand"]                    # Adjusted key for total demand
nuclear_availability = data["nuclear_availability"]
wind_availability = data["wind_availability"]          # Using real wind data
solar_availability = data["solar_availability"]        # Using real solar data
...
axs[0, 0].plot(hours, total_demand, label='Demand', color='black', linestyle='-', marker='o')
axs[0, 0].plot(hours, nuclear_availability, label='Nuclear Availability', color='blue', linestyle='--', marker='o')
axs[0, 0].plot(hours, wind_availability, label='Wind Generation', color='green', linestyle='--', marker='o')
axs[0, 0].plot(hours, solar_availability, label='Solar Generation', color='orange', linestyle='--', marker='o')
...
axs[0, 1].plot(hours, total_demand, label='Demand', color='black', linestyle='-', marker='o')
...
axs[1, 0].plot(hours, total_demand, label='Demand', color='black', linestyle='-', marker='o')
...
axs[1, 1].plot(hours, total_demand, label="Demand", color="black", linestyle='-', marker='o', linewidth=2)  # Plot demand on top
