...
\thesistitle{Platform for Investment Analysis - Part II}
\thesiscontext{Mixed-Integer Linear Programming Optimization for Integrated Energy Systems\\ and Gradient Boosting Decision Trees Forecasting with Python}
\thesisdate{\today}
\thesissemester{FS2025}
...
\input{sections/3-scope}
\input{sections/4-milp}
\input{sections/5-forecasting}
